...
public class ComputerTest extends TestBase {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        Thread.sleep(2000);
        // 2.22 Fill the all mandatory field
        checkOutPage.enterFirstName("Kapil");
        checkOutPage.enterLastName("Santilal");
        checkOutPage.enterEmail("kapil2017@gmail.com");
        ...
        paymentInformationPage.enterCardNumber("5431 1115 1223 1001");
        paymentInformationPage.selectExpiryMonth("09");
        paymentInformationPage.selectExpiryYear("2025");
        paymentInformationPage.enterCardCode("578");
        //2.29 Click on “CONTINUE”
